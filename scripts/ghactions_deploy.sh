...
git config --global user.email "hscott@bu.edu"
git config --global user.name "hgscott/test-memote" 

if [[ "${GITHUB_EVENT_NAME}" == "pull_request" || "${GITHUB_REPOSITORY}" != "hgscott/test-memote" ]]; then
...
echo "Your new report will be visible at https://hgscott.github.io/test-memote in a moment."
